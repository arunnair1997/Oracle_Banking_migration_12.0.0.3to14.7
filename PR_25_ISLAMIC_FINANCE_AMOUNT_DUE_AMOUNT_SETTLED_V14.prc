-- PROCEDURE PR_25_ISLAMIC_FINANCE_AMOUNT_DUE_AMOUNT_SETTLED_V14 (ARUNN_ADMIN)

  CREATE OR REPLACE EDITIONABLE PROCEDURE "ARUNN_ADMIN"."PR_25_ISLAMIC_FINANCE_AMOUNT_DUE_AMOUNT_SETTLED_V14" (p_branch_code IN VARCHAR2,
...
EXCEPTION
  WHEN OTHERS THEN
    ...
    END IF;
    RAISE;
END PR_25_ISLAMIC_FINANCE_AMOUNT_DUE_AMOUNT_SETTLED_V14;
/
/
