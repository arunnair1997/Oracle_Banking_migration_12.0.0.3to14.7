-- PROCEDURE PR_6_ISLAMIC_CASA_V14 (ARUNN_ADMIN)

  CREATE OR REPLACE EDITIONABLE PROCEDURE "ARUNN_ADMIN"."PR_6_ISLAMIC_CASA_V14" (
    ...
    CURSOR c_data IS
        WITH Latest_AFC AS (
            ...
            FROM (
                ...
                FROM INTEGRATEDPP.ACZB_FUNCOL AFC
