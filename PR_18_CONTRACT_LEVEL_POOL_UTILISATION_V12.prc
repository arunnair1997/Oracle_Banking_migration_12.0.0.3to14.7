-- PROCEDURE PR_18_CONTRACT_LEVEL_POOL_UTILISATION_V12 (ARUNN_ADMIN)

  CREATE OR REPLACE EDITIONABLE PROCEDURE "ARUNN_ADMIN"."PR_18_CONTRACT_LEVEL_POOL_UTILISATION_V12" (p_branch_code IN VARCHAR2,
...
BEGIN
  ...
  from getb_utils@fcubsv12 util, getm_pool@fcubsv12 gp
...
EXCEPTION
  WHEN OTHERS THEN
    ...
    END IF;
    RAISE;
END pr_18_contract_level_pool_utilisation_v12;
/
/
