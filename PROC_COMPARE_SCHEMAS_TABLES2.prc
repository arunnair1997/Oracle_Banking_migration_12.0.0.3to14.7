-- PROCEDURE PROC_COMPARE_SCHEMAS_TABLES2 (ARUNN_ADMIN)

  CREATE OR REPLACE EDITIONABLE PROCEDURE "ARUNN_ADMIN"."PROC_COMPARE_SCHEMAS_TABLES2" (V_SCHEMA_A     IN VARCHAR2,
