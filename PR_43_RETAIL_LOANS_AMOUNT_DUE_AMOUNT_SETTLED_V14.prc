-- PROCEDURE PR_43_RETAIL_LOANS_AMOUNT_DUE_AMOUNT_SETTLED_V14 (ARUNN_ADMIN)

  CREATE OR REPLACE EDITIONABLE PROCEDURE "ARUNN_ADMIN"."PR_43_RETAIL_LOANS_AMOUNT_DUE_AMOUNT_SETTLED_V14" (p_branch_code IN VARCHAR2,
...
BEGIN
  -- Construct filename
  l_filename := '43_RETAIL_LOANS_AMOUNT_DUE_AMOUNT_SETTLED_' ||
  ...
  FOR rec IN (SELECT A.ACCOUNT_NUMBER,
                ...
                FROM INTEGRATEDPP.CLZB_ACCOUNT_APPS_MASTER A,
                     INTEGRATEDPP.CLZB_ACCOUNT_SCHEDULES   S
...
EXCEPTION
  WHEN OTHERS THEN
    ...
    END IF;
    RAISE;
END PR_43_RETAIL_LOANS_AMOUNT_DUE_AMOUNT_SETTLED_V14;
/
/
