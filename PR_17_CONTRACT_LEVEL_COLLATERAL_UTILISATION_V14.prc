-- PROCEDURE PR_17_CONTRACT_LEVEL_COLLATERAL_UTILISATION_V14 (ARUNN_ADMIN)

  CREATE OR REPLACE EDITIONABLE PROCEDURE "ARUNN_ADMIN"."PR_17_CONTRACT_LEVEL_COLLATERAL_UTILISATION_V14" (p_branch_code IN VARCHAR2,
...
EXCEPTION
  WHEN OTHERS THEN
    ...
    END IF;
    RAISE;
END pr_17_contract_level_Collateral_utilisation_v14;
/
/
