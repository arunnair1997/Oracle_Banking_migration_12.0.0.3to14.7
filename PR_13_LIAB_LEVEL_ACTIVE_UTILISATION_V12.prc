-- PROCEDURE PR_13_LIAB_LEVEL_ACTIVE_UTILISATION_V12 (ARUNN_ADMIN)

  CREATE OR REPLACE EDITIONABLE PROCEDURE "ARUNN_ADMIN"."PR_13_LIAB_LEVEL_ACTIVE_UTILISATION_V12" (p_branch_code IN VARCHAR2,p_dir IN VARCHAR2) IS
...
dbms_output.put_line('CHECK2');
  ...
  FOR rec IN (select util.customer_no,
                ...
                from getb_utils@fcubsv12     util,
                     getm_liab@fcubsv12      liab,
                     getm_liab_cust@fcubsv12 liabcust
...
EXCEPTION
  WHEN OTHERS THEN
    ...
    END IF;
    RAISE;
END pr_13_liab_level_active_utilisation_v12;
/
/
