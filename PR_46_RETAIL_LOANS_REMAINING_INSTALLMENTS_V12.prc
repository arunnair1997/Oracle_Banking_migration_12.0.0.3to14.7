-- PROCEDURE PR_46_RETAIL_LOANS_REMAINING_INSTALLMENTS_V12 (ARUNN_ADMIN)

  CREATE OR REPLACE EDITIONABLE PROCEDURE "ARUNN_ADMIN"."PR_46_RETAIL_LOANS_REMAINING_INSTALLMENTS_V12" (p_branch_code IN VARCHAR2,
...
BEGIN
  -- Construct filename
  l_filename := '46_RETAIL_LOANS_REMAINING_INSTALLMENTS_' || p_branch_code ||
                '_V12.csv';
  ...
  FOR rec IN (SELECT A.ACCOUNT_NUMBER,
                     ...
                     (SELECT COUNT(*)
                       ...
                       WHERE S1.ACCOUNT_NUMBER = A.ACCOUNT_NUMBER
                         ...
                         AND S1.COMPONENT_NAME = 'MAIN_INT'
...
EXCEPTION
  WHEN OTHERS THEN
    ...
    END IF;
    RAISE;
END PR_46_RETAIL_LOANS_REMAINING_INSTALLMENTS_V12;
/
/
