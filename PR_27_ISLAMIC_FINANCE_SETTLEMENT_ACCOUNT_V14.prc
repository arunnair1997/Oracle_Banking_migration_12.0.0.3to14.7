-- PROCEDURE PR_27_ISLAMIC_FINANCE_SETTLEMENT_ACCOUNT_V14 (ARUNN_ADMIN)

  CREATE OR REPLACE EDITIONABLE PROCEDURE "ARUNN_ADMIN"."PR_27_ISLAMIC_FINANCE_SETTLEMENT_ACCOUNT_V14" (p_branch_code IN VARCHAR2,
...
EXCEPTION
  WHEN OTHERS THEN
    ...
    END IF;
    RAISE;
END PR_27_ISLAMIC_FINANCE_SETTLEMENT_ACCOUNT_V14;
/
/
