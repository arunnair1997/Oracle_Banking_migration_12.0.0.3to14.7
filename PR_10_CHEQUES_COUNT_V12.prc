-- PROCEDURE PR_10_CHEQUES_COUNT_V12 (ARUNN_ADMIN)

  CREATE OR REPLACE EDITIONABLE PROCEDURE "ARUNN_ADMIN"."PR_10_CHEQUES_COUNT_V12" (p_branch_code IN VARCHAR2,
...
BEGIN
  ...
  FOR rec IN (select ccb.account,
                ...
                from ubsprod.catm_check_details@fcubsv12 ccd,
