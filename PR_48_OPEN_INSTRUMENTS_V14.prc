-- PROCEDURE PR_48_OPEN_INSTRUMENTS_V14 (ARUNN_ADMIN)

  CREATE OR REPLACE EDITIONABLE PROCEDURE "ARUNN_ADMIN"."PR_48_OPEN_INSTRUMENTS_V14" (p_dir IN VARCHAR2) IS
...
BEGIN
  -- Construct filename
  l_filename := '48_open_instruments_v14.csv';
...
EXCEPTION
  WHEN OTHERS THEN
    ...
    END IF;
    RAISE;
END pr_48_open_instruments_v14;
/
/
