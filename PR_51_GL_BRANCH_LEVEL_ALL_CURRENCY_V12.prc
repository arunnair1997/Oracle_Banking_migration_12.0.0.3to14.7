-- PROCEDURE PR_51_GL_BRANCH_LEVEL_ALL_CURRENCY_V12 (ARUNN_ADMIN)

  CREATE OR REPLACE EDITIONABLE PROCEDURE "ARUNN_ADMIN"."PR_51_GL_BRANCH_LEVEL_ALL_CURRENCY_V12" (p_branch_code IN VARCHAR2,
...
EXCEPTION
  WHEN OTHERS THEN
    ...
    END IF;
    RAISE;
END PR_51_GL_BRANCH_LEVEL_ALL_CURRENCY_V12;
/
/
