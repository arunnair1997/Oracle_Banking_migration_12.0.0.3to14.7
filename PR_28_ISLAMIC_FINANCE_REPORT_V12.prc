-- PROCEDURE PR_28_ISLAMIC_FINANCE_REPORT_V12 (ARUNN_ADMIN)

  CREATE OR REPLACE EDITIONABLE PROCEDURE "ARUNN_ADMIN"."PR_28_ISLAMIC_FINANCE_REPORT_V12" (p_branch_code IN VARCHAR2,
...
EXCEPTION
  WHEN OTHERS THEN
    ...
    END IF;
    RAISE;
END PR_28_ISLAMIC_FINANCE_REPORT_V12;
/
/
