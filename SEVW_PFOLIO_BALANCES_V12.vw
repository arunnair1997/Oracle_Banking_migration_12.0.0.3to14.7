-- VIEW SEVW_PFOLIO_BALANCES_V12 (ARUNN_ADMIN)

  CREATE OR REPLACE FORCE EDITIONABLE VIEW "ARUNN_ADMIN"."SEVW_PFOLIO_BALANCES_V12" ("BRANCH_CODE", "POSITION_REF_NO", "PORTFOLIO_ID", "SECURITY_ID", "SEC_QUANTITY_TYPE", "OPENING_POSITION", "CURRENT_POSITION", "UNAUTH_BUY_POSITION", "UNAUTH_SELL_POSITION", "UNAUTH_WITHDRAW_POSITION", "UNAUTH_LODGE_POSITION", "OPENING_HOLDING", "CURRENT_HOLDING", "UNAUTH_BUY_HOLDING", "UNAUTH_SELL_HOLDING", "UNAUTH_WITHDRAW_HOLDING", "UNAUTH_LODGE_HOLDING", "OPENING_DELIVERED", "CURRENT_DELIVERED", "OPENING_BALANCE_BLOCKED", "CURRENT_BALANCE_BLOCKED", "UNAUTH_BALANCE_BLOCKED", "UNAUTH_RELEASED_BLOCK", "SCY") AS 
  (
SELECT  a.branch_code,
      ...
      b.security_ccy        scy
  FROM    setb_pfolio_skacbalances@fcubsv12  a,
      setm_security_master@fcubsv12    b
