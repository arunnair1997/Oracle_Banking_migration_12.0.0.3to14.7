-- PROCEDURE PR_20_POOL_DETAILS_V14 (ARUNN_ADMIN)

  CREATE OR REPLACE EDITIONABLE PROCEDURE "ARUNN_ADMIN"."PR_20_POOL_DETAILS_V14" (p_branch_code IN VARCHAR2,
...
BEGIN
  -- Construct filename
  l_filename := '20_Pool_Details' || p_branch_code || '_v14.csv';
