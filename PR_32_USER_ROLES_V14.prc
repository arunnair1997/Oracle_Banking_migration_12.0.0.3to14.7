-- PROCEDURE PR_32_USER_ROLES_V14 (ARUNN_ADMIN)

  CREATE OR REPLACE EDITIONABLE PROCEDURE "ARUNN_ADMIN"."PR_32_USER_ROLES_V14" (p_branch_code IN VARCHAR2,
...
BEGIN
  -- Construct filename
  l_filename := '32_User_roles_' || p_branch_code || '_v14.csv';
