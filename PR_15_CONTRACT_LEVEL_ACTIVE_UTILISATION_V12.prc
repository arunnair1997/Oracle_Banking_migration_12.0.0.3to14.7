-- PROCEDURE PR_15_CONTRACT_LEVEL_ACTIVE_UTILISATION_V12 (ARUNN_ADMIN)

  CREATE OR REPLACE EDITIONABLE PROCEDURE "ARUNN_ADMIN"."PR_15_CONTRACT_LEVEL_ACTIVE_UTILISATION_V12" (p_branch_code IN VARCHAR2,
...
BEGIN
  ...
  FOR rec IN (select customer_no,
                ...
                from ubsprod.getb_utils@fcubsv12
               where util_stat = 'A'
                 and auth_stat = 'A'
...
EXCEPTION
  WHEN OTHERS THEN
    ...
    END IF;
    RAISE;
END pr_15_Contract_level_active_utilisation_v12;
/
/
