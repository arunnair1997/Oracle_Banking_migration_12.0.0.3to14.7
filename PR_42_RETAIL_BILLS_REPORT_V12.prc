-- PROCEDURE PR_42_RETAIL_BILLS_REPORT_V12 (ARUNN_ADMIN)

  CREATE OR REPLACE EDITIONABLE PROCEDURE "ARUNN_ADMIN"."PR_42_RETAIL_BILLS_REPORT_V12" (p_branch_code IN VARCHAR2,
...
BEGIN
  -- Construct filename
  l_filename := '42_Retail_Bills_Report' || p_branch_code || '_v12.csv';
...
EXCEPTION
  WHEN OTHERS THEN
    ...
    END IF;
    RAISE;
END pr_42_Retail_Bills_Report_v12;
/
/
