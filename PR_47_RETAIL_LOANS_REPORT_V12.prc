-- PROCEDURE PR_47_RETAIL_LOANS_REPORT_V12 (ARUNN_ADMIN)

  CREATE OR REPLACE EDITIONABLE PROCEDURE "ARUNN_ADMIN"."PR_47_RETAIL_LOANS_REPORT_V12" (p_branch_code IN VARCHAR2,
...
BEGIN
  -- Construct filename
  l_filename := '47_RETAIL_LOANS_REPORT' || p_branch_code ||
                '_V12.csv';
...
EXCEPTION
  WHEN OTHERS THEN
    ...
    END IF;
    RAISE;
END PR_47_RETAIL_LOANS_REPORT_V12;
/
/
