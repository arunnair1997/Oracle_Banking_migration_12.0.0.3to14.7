-- PROCEDURE PR_24_ISLAMIC_FINANCE_REMAINING_INSTALLMENTS_V12 (ARUNN_ADMIN)

  CREATE OR REPLACE EDITIONABLE PROCEDURE "ARUNN_ADMIN"."PR_24_ISLAMIC_FINANCE_REMAINING_INSTALLMENTS_V12" (p_branch_code IN VARCHAR2,
...
EXCEPTION
  WHEN OTHERS THEN
    ...
    END IF;
    RAISE;
END PR_24_ISLAMIC_FINANCE_REMAINING_INSTALLMENTS_V12;
/
/
