-- PROCEDURE PR_43_RETAIL_LOANS_AMOUNT_DUE_AMOUNT_SETTLED_V12 (ARUNN_ADMIN)

  CREATE OR REPLACE EDITIONABLE PROCEDURE "ARUNN_ADMIN"."PR_43_RETAIL_LOANS_AMOUNT_DUE_AMOUNT_SETTLED_V12" (p_branch_code IN VARCHAR2,
...
EXCEPTION
  WHEN OTHERS THEN
    ...
    END IF;
    RAISE;
END PR_43_RETAIL_LOANS_AMOUNT_DUE_AMOUNT_SETTLED_V12;
/
/
