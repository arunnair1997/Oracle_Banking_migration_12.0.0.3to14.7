-- PROCEDURE PR_24_ISLAMIC_FINANCE_REMAINING_INSTALLMENTS_V12_RIZ (ARUNN_ADMIN)

  CREATE OR REPLACE EDITIONABLE PROCEDURE "ARUNN_ADMIN"."PR_24_ISLAMIC_FINANCE_REMAINING_INSTALLMENTS_V12_RIZ" (p_branch_code IN VARCHAR2,
...
BEGIN
  ...
  l_filename := 'PR_24_ISLAMIC_FINANCE_REMAINING_INSTALLMENTS_' || p_branch_code ||
...
JOIN UBSPROD.STTM_CUSTOMER@FCUBSV12 B ON A.CUSTOMER_ID = B.CUSTOMER_NO
...
END PR_24_ISLAMIC_FINANCE_REMAINING_INSTALLMENTS_V12_RIZ;
/
/
