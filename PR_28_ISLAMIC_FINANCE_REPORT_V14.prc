-- PROCEDURE PR_28_ISLAMIC_FINANCE_REPORT_V14 (ARUNN_ADMIN)

  CREATE OR REPLACE EDITIONABLE PROCEDURE "ARUNN_ADMIN"."PR_28_ISLAMIC_FINANCE_REPORT_V14" (p_branch_code IN VARCHAR2,
...
BEGIN
  -- Construct filename
  l_filename := '28_ISLAMIC_FINANCE_REPORT' || p_branch_code ||
                '_V14.csv';
...
EXCEPTION
  WHEN OTHERS THEN
    ...
    END IF;
    RAISE;
END PR_28_ISLAMIC_FINANCE_REPORT_V14;
/
/
