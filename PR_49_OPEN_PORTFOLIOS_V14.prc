-- PROCEDURE PR_49_OPEN_PORTFOLIOS_V14 (ARUNN_ADMIN)

  CREATE OR REPLACE EDITIONABLE PROCEDURE "ARUNN_ADMIN"."PR_49_OPEN_PORTFOLIOS_V14" (
...
BEGIN
  -- Construct filename
  l_filename := '49_Open_Portfolios_v14.csv';
