-- PROCEDURE PR_53_GL_RECON_TOTAL_BANK_V14 (ARUNN_ADMIN)

  CREATE OR REPLACE EDITIONABLE PROCEDURE "ARUNN_ADMIN"."PR_53_GL_RECON_TOTAL_BANK_V14" (p_dir         IN VARCHAR2) IS
...
BEGIN
  -- Construct filename
  l_filename := '53_GL_RECON_TOTAL_BANK_V14.csv';
...
EXCEPTION
  WHEN OTHERS THEN
    ...
    END IF;
    RAISE;
END PR_53_GL_RECON_TOTAL_BANK_V14;
/
/
