-- PROCEDURE PR_56_LIAB_UDF_BK (ARUNN_ADMIN)

  CREATE OR REPLACE EDITIONABLE PROCEDURE "ARUNN_ADMIN"."PR_56_LIAB_UDF_BK" (p_branch_code IN VARCHAR2,
       ...
       AND v12.liab_branch = v14.liab_branch
        ...
        ORDER BY v12.liab_branch, v12.liab_no
            ...
            l_line := rec.liab_no || ',' ||
                  ...
                  rec.udf_value_1 || ',' || rec.field_val_1 || ',' ||

                  rec.udf_value_2 || ',' || rec.field_val_2 || ',' ||

                  rec.udf_value_3 || ',' || rec.field_val_3 || ',' ||

                  rec.udf_value_4 || ',' || rec.field_val_4 || ',' ||

                  rec.udf_value_5 || ',' || rec.field_val_5 || ',' ||

                  rec.udf_value_6 || ',' || rec.field_val_6 || ',' ||

                  rec.udf_value_7 || ',' || rec.field_val_7 || ',' ||

                  rec.udf_value_8 || ',' || rec.field_val_8 || ',' ||

                  rec.udf_value_9 || ',' || rec.field_val_9 || ',' ||

                  rec.udf_value_10 || ',' || rec.field_val_10 || ',' ||

                  rec.udf_value_11 || ',' || rec.field_val_11 || ',' ||

                  rec.udf_value_12 || ',' || rec.field_val_12 || ',' ||

                  rec.udf_value_13 || ',' || rec.field_val_13 || ',' ||

                  rec.udf_value_14 || ',' || rec.field_val_14 || ',' ||

                  rec.udf_value_15 || ',' || rec.field_val_15 || ',' ||

                  rec.udf_value_16 || ',' || rec.field_val_16 || ',' ||

                  rec.udf_value_17 || ',' || rec.field_val_17 || ',' ||

                  rec.udf_value_18 || ',' || rec.field_val_18 || ',' ||

                  rec.udf_value_19 || ',' || rec.field_val_19 || ',' ||

                  rec.udf_value_20 || ',' || rec.field_val_20 || ',' ||

                  rec.udf_value_21 || ',' || rec.field_val_21 || ',' ||

                  rec.udf_value_22 || ',' || rec.field_val_22 || ',' ||

                  rec.udf_value_23 || ',' || rec.field_val_23 || ',' ||

                  rec.udf_value_24 || ',' || rec.field_val_24 || ',' ||

                  rec.udf_value_25 || ',' || rec.field_val_25 || ',' ||

                  rec.udf_value_26 || ',' || rec.field_val_26 || ',' ||

                  rec.udf_value_27 || ',' || rec.field_val_27 || ',' ||

                  rec.udf_value_28 || ',' || rec.field_val_28 || ',' ||

                  rec.udf_value_29 || ',' || rec.field_val_29 || ',' ||

                  rec.udf_value_30 || ',' || rec.field_val_30 || ',' ||

                  rec.udf_value_31 || ',' || rec.field_val_31 || ',' ||

                  rec.udf_value_32 || ',' || rec.field_val_32 || ',' ||

                  rec.udf_value_33 || ',' || rec.field_val_33 || ',' ||

                  rec.udf_value_34 || ',' || rec.field_val_34 || ',' ||

                  rec.udf_value_35 || ',' || rec.field_val_35 || ',' ||

                  rec.udf_value_36 || ',' || rec.field_val_36 || ',' ||

                  rec.udf_value_37 || ',' || rec.field_val_37 || ',' ||

                  rec.udf_value_38 || ',' || rec.field_val_38 || ',' ||

                  rec.udf_value_39 || ',' || rec.field_val_39 || ',' ||

                  rec.udf_value_40 || ',' || rec.field_val_40 || ',' ||

                  rec.udf_value_41 || ',' || rec.field_val_41 || ',' ||

                  rec.udf_value_42 || ',' || rec.field_val_42 || ',' ||

                  rec.udf_value_43 || ',' || rec.field_val_43 || ',' ||

                  rec.udf_value_44 || ',' || rec.field_val_44 || ',' ||

                  rec.udf_value_45 || ',' || rec.field_val_45 || ',' ||

                  rec.udf_value_46 || ',' || rec.field_val_46 || ',' ||

                  rec.udf_value_47 || ',' || rec.field_val_47 || ',' ||

                  rec.udf_value_48 || ',' || rec.field_val_48 || ',' ||

                  rec.udf_value_49 || ',' || rec.field_val_49 || ',' ||

                  rec.udf_value_50 || ',' || rec.field_val_50;
