-- PROCEDURE PR_36_OUTSTANDING_DD_TT_BC_SUMM (ARUNN_ADMIN)

  CREATE OR REPLACE EDITIONABLE PROCEDURE "ARUNN_ADMIN"."PR_36_OUTSTANDING_DD_TT_BC_SUMM" (p_branch_code IN VARCHAR2,
...
BEGIN
  ...
  l_filename := '36_OUTSTANDING_DD_TT_BC_' || p_branch_code || '_SUMM.csv';
...
EXCEPTION
  WHEN OTHERS THEN
    ...
    END IF;
    RAISE;
END PR_36_OUTSTANDING_DD_TT_BC_SUMM;
