-- PROCEDURE PR_30_MIGRATED_ROLES_V14 (ARUNN_ADMIN)

  CREATE OR REPLACE EDITIONABLE PROCEDURE "ARUNN_ADMIN"."PR_30_MIGRATED_ROLES_V14" (p_dir IN VARCHAR2) IS
...
BEGIN
  -- Construct filename
  l_filename := '30_Migrated_roles_v14.csv';
  ...
  FOR rec IN (select ROLE_ID,
                     ...
                     BRANCH_AUTH_ROLE,
                     CENTRALISATION_ROLE
                from integratedpp.SMZB_ROLE_MASTER
               where record_stat = 'O'
