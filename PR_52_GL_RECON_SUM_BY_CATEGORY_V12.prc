-- PROCEDURE PR_52_GL_RECON_SUM_BY_CATEGORY_V12 (ARUNN_ADMIN)

  CREATE OR REPLACE EDITIONABLE PROCEDURE "ARUNN_ADMIN"."PR_52_GL_RECON_SUM_BY_CATEGORY_V12" (p_branch_code IN VARCHAR2,
...
EXCEPTION
  WHEN OTHERS THEN
    ...
    END IF;
    RAISE;
END PR_52_GL_RECON_SUM_BY_CATEGORY_V12;
/
/
