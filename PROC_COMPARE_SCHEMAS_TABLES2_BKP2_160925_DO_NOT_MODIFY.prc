-- PROCEDURE PROC_COMPARE_SCHEMAS_TABLES2_BKP2_160925_DO_NOT_MODIFY (ARUNN_ADMIN)

  CREATE OR REPLACE EDITIONABLE PROCEDURE "ARUNN_ADMIN"."PROC_COMPARE_SCHEMAS_TABLES2_BKP2_160925_DO_NOT_MODIFY" (V_SCHEMA_A     IN VARCHAR2,
