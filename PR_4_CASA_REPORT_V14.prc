-- PROCEDURE PR_4_CASA_REPORT_V14 (ARUNN_ADMIN)

  CREATE OR REPLACE EDITIONABLE PROCEDURE "ARUNN_ADMIN"."PR_4_CASA_REPORT_V14" (p_branch_code IN VARCHAR2,
  ...
  BEGIN
    -- Construct filename
    l_filename := '4_CASA_REPORT_' || p_branch_code || '_v14.csv';
