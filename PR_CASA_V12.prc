-- PROCEDURE PR_CASA_V12 (ARUNN_ADMIN)

  CREATE OR REPLACE EDITIONABLE PROCEDURE "ARUNN_ADMIN"."PR_CASA_V12" (
    ...
    CURSOR c_data IS
      ...
      FUF.FIELD_VAL_26
        ...
        LEFT JOIN UBSPROD.CSTM_FUNCTION_USERDEF_FIELDS@FCUBSV12 FUF
              ...
              AND CAC.CUST_AC_NO = SUBSTR(FUF.REC_KEY,
