-- PROCEDURE PR_46_RETAIL_LOANS_REMAINING_INSTALLMENTS_V14 (ARUNN_ADMIN)

  CREATE OR REPLACE EDITIONABLE PROCEDURE "ARUNN_ADMIN"."PR_46_RETAIL_LOANS_REMAINING_INSTALLMENTS_V14" (p_branch_code IN VARCHAR2,
...
BEGIN
  -- Construct filename
  l_filename := '46_RETAIL_LOANS_REMAINING_INSTALLMENTS_' ||
...
EXCEPTION
  WHEN OTHERS THEN
    ...
    END IF;
    RAISE;
END PR_46_RETAIL_LOANS_REMAINING_INSTALLMENTS_V14;
/
/
