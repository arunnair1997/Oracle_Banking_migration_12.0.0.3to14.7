-- PROCEDURE PR_7_IA_TD_REPORT_V14 (ARUNN_ADMIN)

  CREATE OR REPLACE EDITIONABLE PROCEDURE "ARUNN_ADMIN"."PR_7_IA_TD_REPORT_V14" (p_branch_code IN VARCHAR2,
...
BEGIN
  -- Construct filename
  l_filename := '7_ISLAMIC_TD_REPORT_' || p_branch_code || '_v14.csv';
  ...
  FOR rec IN (select * from islamic_td_report where brn=p_branch_code ) LOOP
