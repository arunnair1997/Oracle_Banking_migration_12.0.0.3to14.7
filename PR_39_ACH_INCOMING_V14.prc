-- PROCEDURE PR_39_ACH_INCOMING_V14 (ARUNN_ADMIN)

  CREATE OR REPLACE EDITIONABLE PROCEDURE "ARUNN_ADMIN"."PR_39_ACH_INCOMING_V14" (p_branch_code IN VARCHAR2,
...
BEGIN
  -- Construct filename
  l_filename := '38_ACH_INCOMING_' || p_branch_code || '_v14.csv';
