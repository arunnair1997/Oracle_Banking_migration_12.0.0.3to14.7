-- PROCEDURE PR_38_ACH_OUTGOING_V12 (ARUNN_ADMIN)

  CREATE OR REPLACE EDITIONABLE PROCEDURE "ARUNN_ADMIN"."PR_38_ACH_OUTGOING_V12" (p_branch_code IN VARCHAR2,
...
BEGIN
  -- Construct filename
  l_filename := '38_ACH_OUTGOING_' || p_branch_code || '_v12.csv';
