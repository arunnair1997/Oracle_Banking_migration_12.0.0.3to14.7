-- PROCEDURE PR_1_CIF_V12 (ARUNN_ADMIN)

  CREATE OR REPLACE EDITIONABLE PROCEDURE "ARUNN_ADMIN"."PR_1_CIF_V12" (p_branch_code IN VARCHAR2,
...
BEGIN
  ...
  FOR rec IN (SELECT CIF.CUSTOMER_NO,
                     ...
                     CIU.FIELD_VAL_21,
                     CIU.FIELD_VAL_22
                FROM UBSPROD.STTM_CUSTOMER@FCUBSV12 CIF
                LEFT JOIN UBSPROD.STTM_CUST_PERSONAL@fcubsv12 CIP
                  ON CIF.CUSTOMER_NO = CIP.CUSTOMER_NO
                LEFT JOIN UBSPROD.CSTM_FUNCTION_USERDEF_FIELDS@fcubsv12 CIU
