-- PROCEDURE PR_12_SAFE_DEPOSIT_BOX_CONTRACTS_V14 (ARUNN_ADMIN)

  CREATE OR REPLACE EDITIONABLE PROCEDURE "ARUNN_ADMIN"."PR_12_SAFE_DEPOSIT_BOX_CONTRACTS_V14" (p_branch_code IN VARCHAR2,
...
EXCEPTION
  WHEN OTHERS THEN
    ...
    END IF;
    RAISE;
END pr_12_SAFE_DEPOSIT_BOX_CONTRACTS_v14;
/
/
